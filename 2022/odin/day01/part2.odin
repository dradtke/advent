...
run :: proc(input: string) -> string {
  ...
  slice.reverse_sort(calorie_counts[:])
  total := calorie_counts[0] + calorie_counts[1] + calorie_counts[2]
  return fmt.aprintf("%d", total)
}
...
10000`)
  testing.expect_value(t, result, "45000")
}
